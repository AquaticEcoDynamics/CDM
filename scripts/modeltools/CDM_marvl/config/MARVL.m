...
% Models
master.ncfile(1).name = '/Projects2/CDM2022/eWater2022-scenarios-VH-paper/output_basecase_005_202211/eWater_basecase_005_202211_all.nc';
...
master.ncfile(1).legend = 'CDM2.1';
master.ncfile(1).tag = 'TFV';

%master.ncfile(2).name = '/Projects2/csiem/Model/TFV/csiem_model_tfvaed_1.0/tfvaed_1.0/outputs/results_wrf/csiem_100_A_20220101_20221231_WQ_009_WWM_WRF_GW_WQ.nc';
%'E:\database\csiem_100_A_20130101_20130601_WQ_009_diag_1_WQ.nc';
%'E:\database\csiem_100_A_20130101_20130601_WQ_009_WQ_plot_ks.nc';
%master.ncfile(2).legend = 'WRF-2022';
%master.ncfile(2).tag = 'TFV';

% field data
master.add_fielddata = 1;
master.fielddata_matfile = '/Projects2/CDM2022/AED-MARVL-v0.4/Projects/Coorong/cllmm.mat';
master.fielddata = 'cllmm'; %'swan';
...
timeseries.edge_color = {[8,88,158]./255;[166,86,40]./255}; % symbol edge color for field data, surface and bottom
...
timeseries.SkillStyle = 'tailor'; % 'score' for score table or 'tailor' for tailor diagram
...
timeseries.outputdirectory = '../outputs/timeseries_tailor_CDM21/RAW/';
timeseries.htmloutput = '../outputs/timeseries_tailor_CDM21/HTML/';
timeseries.ErrFilename = '../outputs/timeseries_tailor_CDM21/errormatrix.mat';
...
timeseries.ncfile(2).colour = {[8,88,158]./255;[166,86,40]./255};% Surface and Bottom
...
timeseries.datearray = datenum(2017,7:6:77,1);
timeseries.dateformat = 'mmm/yy';
