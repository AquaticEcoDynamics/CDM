function plottfv_averaged_4_panel_coorong_sheet_inserts_lims_2_combo_f_o(ncfile,outdir,scenario,year,windowLength,averageLength)
...
% windowLength  = 150.0;
% averageLength = 90.0;
windowLength  = 60.0;  %to end of Oct only
averageLength = 60.0;
