...
setwd("D:/HCHB_GEN2_4yrs_20220620/Plotting_Ruppia/hchb_Gen2_201707_202201_all/Sheets/shp") #set the folder of all the files to be looped
...
for (y in 1:length(yr)){
  ...
  # first <- stri_extract_all_regex(ticks, "[0-9]+")  #not working
  # first <- str_extract(ticks[1], "(\\d)+(?=,)")
  # first <- sub(",.*","",ticks[1])
  # first <- strsplit(newticks[1], "[-]")[[1]][1]
  # gsub(strsplit(ticks[1], "[,]")[[1]][1],"0",ticks[1])
  # gsub("[.*,]","0",ticks[1])
  # strsplit(ticks[1], "[,]")[[1]][1]
  # gsub(strsplit(ticks[1], "[,]")[[1]][1],"0",ticks[1])
  # as.numeric(str_extract(ticks[1], "(\\d)+(?=,)"),"0",ticks[1])
  # df_valid[[y]]$label <- str_extract(df_valid[[y]]$obsqt,"(?i)(?<=,\\D)\\d+")
  # first <- str_extract(ticks[1], "(\\d)+(?=,)")
  ...
  R <- format(cor(df_valid_S[[y]][2],df_valid_S[[y]][5],use="complete.obs"), digits = 2)
  ...
  print(fig)
  ggsave("C:/Users/00101765/AED Dropbox/AED_Coorong_db/7_hchb/Ruppia/R plots/validation/flower2020_sexual2020.png", 
...
#  include.lowest = TRUE,dig.lab=10)
  ...
  fig <-  ggarrange(p1,p2,p3,p4, ncol=2,nrow=2,align = "hv")
  print(fig)
  ggsave("C:/Users/00101765/AED Dropbox/AED_Coorong_db/7_hchb/Ruppia/R plots/validation/flower2021_sexual2021.png", 
         width = 20, height = 20, units = "cm",dpi = 300)
  #  } else {print(paste0(as.character(yr[y])," HSI (flower) and/or ",as.character(yr[y]+1)," field data do not exist (seed)"))}
}
...
for (y in 1:length(yr)){
  ...
  fig <-  ggarrange(p1,p2,p3,p4, ncol=2,nrow=2,align = "hv")
  ggsave("C:/Users/00101765/AED Dropbox/AED_Coorong_db/7_hchb/Ruppia/R plots/validation/seed2021_sexual2020.png", 
         width = 20, height = 20, units = "cm",dpi = 300)
  print(fig)
  #  } else {print(paste0(as.character(yr[y])," HSI (flower) and/or ",as.character(yr[y]+1)," field data do not exist (seed)"))}
}
...
for (y in 1:length(yr)){
  ...
  fig <-  ggarrange(p1,p2,p3,p4, ncol=2,nrow=2,align = "hv")
  print(fig)
  ggsave("C:/Users/00101765/AED Dropbox/AED_Coorong_db/7_hchb/Ruppia/R plots/validation/seed2021_sexual2021.png", 
         width = 20, height = 20, units = "cm",dpi = 300)
  #  } else {print(paste0(as.character(yr[y])," HSI (flower) and/or ",as.character(yr[y]+1)," field data do not exist (seed)"))}
}
...
for (y in 1:length(yr)){
  ...
  fig <-  ggarrange(p1,p2,p3,p4, ncol=2,nrow=2,align = "hv")
  print(fig)
  ggsave("C:/Users/00101765/AED Dropbox/AED_Coorong_db/7_hchb/Ruppia/R plots/validation/turion2020_asexual2020.png", 
         width = 20, height = 20, units = "cm",dpi = 300)
  #  } else {print(paste0(as.character(yr[y])," HSI (flower) and/or ",as.character(yr[y]+1)," field data do not exist (seed)"))}
}
...
for (y in 1:length(yr)){
  ...
  fig <-  ggarrange(p1,p2,p3,p4, ncol=2,nrow=2,align = "hv")
  print(fig)
  ggsave("C:/Users/00101765/AED Dropbox/AED_Coorong_db/7_hchb/Ruppia/R plots/validation/turion2021_asexual2021.png", 
         width = 20, height = 20, units = "cm",dpi = 300)
  #  } else {print(paste0(as.character(yr[y])," HSI (flower) and/or ",as.character(yr[y]+1)," field data do not exist (seed)"))}
}
...
for (y in 1:length(yr)){
  ...
  fig <-  ggarrange(p1,p2,p3,p4,ncol=2,nrow=2,align = "hv")
  print(fig)
  ggsave("C:/Users/00101765/AED Dropbox/AED_Coorong_db/7_hchb/Ruppia/R plots/validation/turion2021_asexual2020.png", 
         width = 20, height = 20, units = "cm",dpi = 300)
  #  } else {print(paste0(as.character(yr[y])," HSI (flower) and/or ",as.character(yr[y]+1)," field data do not exist (seed)"))}
}
...
for (y in 1:length(yr)){
  ...
  fig <-  ggarrange(p1,p2,p3,p4, ncol=2,nrow=2,align = "hv")
  print(fig)
  ggsave("C:/Users/00101765/AED Dropbox/AED_Coorong_db/7_hchb/Ruppia/R plots/validation/shoot2020_germspradt2020.png", 
         width = 20, height = 20, units = "cm",dpi = 300)
  #  } else {print(paste0(as.character(yr[y])," HSI (flower) and/or ",as.character(yr[y]+1)," field data do not exist (seed)"))}
}
...
for (y in 1:length(yr)){
  ...
  fig <-  ggarrange(p1,p2,p3,p4, ncol=2,nrow=2,align = "hv")
  print(fig)
  ggsave("C:/Users/00101765/AED Dropbox/AED_Coorong_db/7_hchb/Ruppia/R plots/validation/shoot2021_germspradt2021.png", 
         width = 20, height = 20, units = "cm",dpi = 300)
  #  } else {print(paste0(as.character(yr[y])," HSI (flower) and/or ",as.character(yr[y]+1)," field data do not exist (seed)"))}
}
...
for (y in 1:length(yr)){
  ...
  fig <-  ggarrange(p1,p2,p3,p4, ncol=2,nrow=2,align = "hv")
  print(fig)
  ggsave("C:/Users/00101765/AED Dropbox/AED_Coorong_db/7_hchb/Ruppia/R plots/validation/shoot2021_germspradt2021_11.png", 
         width = 20, height = 20, units = "cm",dpi = 300)
  #  } else {print(paste0(as.character(yr[y])," HSI (flower) and/or ",as.character(yr[y]+1)," field data do not exist (seed)"))}
}
...
for (y in 1:length(yr)){
  ...
  fig <-  ggarrange(p1,p2,p3,p4, ncol=2,nrow=2,align = "hv")
  print(fig)
  ggsave(paste0("C:/Users/00101765/AED Dropbox/AED_Coorong_db/7_hchb/Ruppia/R plots/validation_mag0621/algae_biomass_",yr[y],".png"), 
         width = 20, height = 20, units = "cm",dpi = 300)
  #  } else {print(paste0(as.character(yr[y])," HSI (flower) and/or ",as.character(yr[y]+1)," field data do not exist (seed)"))}
}
...
for (y in 1:length(yr)){
  ...
  df_valid[[y]] <- st_drop_geometry(valid[[y]]) #remove the geometry for correlation analysis
  R <- format(cor(df_valid[[y]][6],df_valid[[y]][2],use="complete.obs"), digits = 2)
  ...
  fig <-  ggarrange(p1,p2,p3,p4, ncol=2,nrow=2,align = "hv")
  print(fig)
  ggsave(paste0("C:/Users/00101765/AED Dropbox/AED_Coorong_db/7_hchb/Ruppia/R plots/validation_mag0621/algaecover_HSI_",yr[y],".png"), 
         width = 20, height = 20, units = "cm",dpi = 300)
  #  } else {print(paste0(as.character(yr[y])," HSI (flower) and/or ",as.character(yr[y]+1)," field data do not exist (seed)"))}
}
...
for (y in 1:length(yr)){
  ...
  fig <-  ggarrange(p1,p2,p3,p4, ncol=2,nrow=2,align = "hv")
  print(fig)
  ggsave(paste0("C:/Users/00101765/AED Dropbox/AED_Coorong_db/7_hchb/Ruppia/R plots/validation_mag0621/biomass_HSI",yr[y],".png"), 
         width = 20, height = 20, units = "cm",dpi = 300)
  #  } else {print(paste0(as.character(yr[y])," HSI (flower) and/or ",as.character(yr[y]+1)," field data do not exist (seed)"))}
}
