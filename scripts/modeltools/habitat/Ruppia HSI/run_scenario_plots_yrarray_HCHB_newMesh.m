...
scenarios = {...
    'eWater_basecase_newMesh_BB_TEST_v4_all',...
%    'eWater_NC5_all',...
%     'eWater_NE5_all',...
%     'eWater_NC1_all',...
%     'eWater_NC2_all',...
...
min_size = 30000;
 ...
 year_array = 2020:2021; % 2018:2019;
...
for i = 1:length(scenarios)
    ...
    filename = ['E:\CDM22_newMesh_BB\',scenarios{i},'.nc'];
...
%             end
            ...
            for j=1:length(year_array)
                ...
                outdir = ['E:\CDM22_newMesh_BB\Plotting_Ruppia\',scenarios{i},'\Sheets\',num2str(year_array(j)),'\'];
                outdirshp = ['E:\CDM22_newMesh_BB\Plotting_Ruppia\',scenarios{i},'\Sheets\shp\'];
...
%      % Plots to the sheets directory
          ...
          %default timeframe
                ...
                save([outdir,'HSI_seed_sprout.mat'],'hsi_seed_sprout','-mat');
               
        
        if i == 1   % for basecase validation only      
                                  
              % convert to shp
                convert_2dm_to_shp('Coorong_detailed_006_AED_v5.2dm',[outdirshp, 'HSI_germ_spr',modname, num2str(year_array(j)),'.shp'],'HSI',hsi_seed_sprout); 
                convert_2dm_to_shp('Coorong_detailed_006_AED_v5.2dm',[outdirshp, 'HSI_viab_spr',modname, num2str(year_array(j)),'.shp'],'HSI',hsi_viab_sprout); 
                convert_2dm_to_shp('Coorong_detailed_006_AED_v5.2dm',[outdirshp, 'HSI_adult',modname, num2str(year_array(j)),'.shp'],'HSI',hsi1.min_cdata);
                convert_2dm_to_shp('Coorong_detailed_006_AED_v5.2dm',[outdirshp, 'HSI_flower',modname, num2str(year_array(j)),'.shp'],'HSI',hsi2.min_cdata);
                convert_2dm_to_shp('Coorong_detailed_006_AED_v5.2dm',[outdirshp, 'HSI_turion', modname,num2str(year_array(j)),'.shp'],'HSI',hsi4.min_cdata);
                convert_2dm_to_shp('Coorong_detailed_006_AED_v5.2dm',[outdirshp, 'HSI_viability', modname,num2str(year_array(j)),'.shp'],'HSI',hsi6.min_cdata);
                convert_2dm_to_shp('Coorong_detailed_006_AED_v5.2dm',[outdirshp, 'HSI_germ_spr_adt', modname,num2str(year_array(j)),'.shp'],'HSI',hsi_seed_spr_adt);
                convert_2dm_to_shp('Coorong_detailed_006_AED_v5.2dm',[outdirshp, 'HSI_ulva', modname,num2str(year_array(j)),'_11.shp'],'HSI',hsiulva.min_cdata);
                convert_2dm_to_shp('Coorong_detailed_006_AED_v5.2dm',[outdirshp, 'BIOMASS_ulva', modname,num2str(year_array(j)),'_11.shp'],'HSI',biomassulva.ave_data);
                convert_2dm_to_shp('Coorong_detailed_006_AED_v5.2dm',[outdirshp, 'BENTHIC_ulva', modname,num2str(year_array(j)),'_11.shp'],'HSI',benthiculva.ave_data);
          ...
          if year_array(j) == 2020 || year_array(j) == 2021
                ...
                convert_2dm_to_shp('Coorong_detailed_006_AED_v5.2dm',[outdirshp, 'HSI_germ_spr_adt', modname,num2str(year_array(j)),'_11.shp'],'HSI',hsi_seed_spr_adt_nov);                
                convert_2dm_to_shp('Coorong_detailed_006_AED_v5.2dm',[outdirshp, 'HSI_flower',modname, num2str(year_array(j)),'_10.shp'],'HSI',hsi2_o.min_cdata);
                convert_2dm_to_shp('Coorong_detailed_006_AED_v5.2dm',[outdirshp, 'HSI_turion', modname,num2str(year_array(j)),'_10.shp'],'HSI',hsi4_o.min_cdata);
          end      
          ...
          if year_array(j) == 2018
                ...
                convert_2dm_to_shp('Coorong_detailed_006_AED_v5.2dm',[outdirshp, 'HSI_germ_spr_adt', modname,num2str(year_array(j)),'_6.shp'],'HSI',hsi_seed_spr_adt_jun);
                convert_2dm_to_shp('Coorong_detailed_006_AED_v5.2dm',[outdirshp, 'HSI_germ_spr_adt', modname,num2str(year_array(j)),'_12.shp'],'HSI',hsi_seed_spr_adt_dec);
          end      
        end     
...
%%                
                ...
                convert_2dm_to_shp('Coorong_detailed_006_AED_v5.2dm',[outdirshp, 'HSI_sexual',modname, num2str(year_array(j)),'_12.shp'],'HSI',min_cdata);
                ...
                convert_2dm_to_shp('Coorong_detailed_006_AED_v5.2dm',[outdirshp, 'HSI_asexual',modname, num2str(year_array(j)),'_12.shp'],'HSI',min_cdata);
                ...
                convert_2dm_to_shp('Coorong_detailed_006_AED_v5.2dm',[outdirshp, 'HSI_combined',modname, num2str(year_array(j)),'_12.shp'],'HSI',hsi_combined);
 ...
 %%
                ...
                convert_2dm_to_shp('Coorong_detailed_006_AED_v5.2dm',[outdirshp, 'HSI_germ_spr_adt',modname, num2str(year_array(j)),'.shp'],'HSI',min_cdata);           
       ...
       if i == 1   % for basecase validation only 
            ...
            if year_array(j) == 2020 || year_array(j) == 2021
                ...
                convert_2dm_to_shp('Coorong_detailed_006_AED_v5.2dm',[outdirshp, 'HSI_sexual',modname, num2str(year_array(j)),'_10.shp'],'HSI',min_cdata);
                ...
                convert_2dm_to_shp('Coorong_detailed_006_AED_v5.2dm',[outdirshp, 'HSI_asexual',modname, num2str(year_array(j)),'_10.shp'],'HSI',min_cdata);           
            end   
       end  
