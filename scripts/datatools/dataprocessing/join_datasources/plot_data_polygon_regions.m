...
load ../../../../data/store/archive/lowerlakes.mat;

shp = shaperead('../../../../gis/supplementary/Coorong/Final_Ruppia_Area.shp');

outdir = '../../../../data/store/archive/Images/RAW/'; 
...
for i = 1:length(vars)
    ...
    for j = 1:length(shp)
        ...
        xarray = datenum(2008:01:2022,01,01);
