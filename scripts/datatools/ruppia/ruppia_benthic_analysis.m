...
load('../../../data/store/ecology/baseline_ruppia.mat');
%load('../../../data/store/ecology/phenology.mat');

phenology = baseline_ruppia;
...
outfile = ['Ruppia_Analysis_100sites_',datestr(startdate,'yyyymmdd'),'_',datestr(enddate,'yyyymmdd'),'.csv'];
