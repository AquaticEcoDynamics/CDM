function create_wave_model_from_tfv_rotate
...
cell_size = 100;
wind_cell_size = 100;% Currently does nothing
...
model_project_name = 'Coorong_swn_20210227_20210307_rot';
...
[xStart,yStart,xLength,yLength,xNum,yNum,xStartW,yStartW,xLengthW,yLengthW,xNumW,yNumW] ...
    = create_swan_bathy_from_2dm(tfv_bathy,cell_size,model_project_name,wind_cell_size,rot);
...
function [xStart,yStart,xLength,yLength,xNum,yNum,xStartW,yStartW,xLengthW,yLengthW,xNumW,yNumW] ...
    = create_swan_bathy_from_2dm(filename,cell_size,model_project_name,wind_cell_size,rot)
...
xarray=xStarti:200:xStarti+xLengthi;
yarray=yStarti:200:yStarti+yLengthi;
