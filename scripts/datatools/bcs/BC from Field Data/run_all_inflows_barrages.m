...
lowerlakes = cllmm;
datearray(:,1) = datenum(2012,01,01,00,00,00):1:datenum(2022,01,01,00,00,00);
...
filename = [outdir,'Salt_Creek_20120101_20220101.csv'];
...
filename = [outdir,'Tauwitchere_20120101_20220101.csv'];
...
filename = [outdir,'Ewe_20120101_20220101.csv'];
subdir = [outdir,'Ewe/'];
...
filename = [outdir,'Boundary_20120101_20220101.csv'];
...
filename = [outdir,'Mundoo_20120101_20220101.csv'];
...
filename = [outdir,'Goolwa_20120101_20220101.csv'];
...
filename = [outdir,'BK_20120101_20220101.csv'];
subdir = [outdir,'BK/'];
