...
outdir = 'BCs_Albert_Pumping_Phase_2/';
...
datearray(:,1) = datenum(2014,01,01,00,00,00):1:datenum(2020,07,01,00,00,00);
...
% filename = [outdir,'Albert_Opening_20140101_20200701.csv'];
...
filename = [outdir,'Albert_Phase_II_20140101_20200701.csv'];
...
filename = [outdir,'River_Phase_II_20120101_20210701.csv'];
