...
-	Coupling of the TUFLOW-FV hydrodynamic model with biogeochemical and habitat models, as required to support HCHB goals.
-	Development of improved model representation of:
    -	external and internal nutrient loads
    - sediment loads, nutrient fluxes and cycling
...
-	Linking the ecological model approaches to the above model framework, including:
    ...
    -	food webs (incl. fish)
-	Testing, validation and scenarios using the improved and integrated models and frameworks.
