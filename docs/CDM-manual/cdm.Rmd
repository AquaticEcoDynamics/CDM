...
The CDM has been designed is such a way to facilitate *********************

-	**Repository folder structure (folder address and access)**

The folders structure follows the logic of data types and resources as shown in Figure **. 
...
- **Model organisation**
Each version of model files are organized in following folders:
